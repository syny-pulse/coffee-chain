...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 brand-heading">All products</h4>

        </div>
<a href="{{ route('product.add') }}" class="btn btn-custom btn-rounded waves-effect waves-light" style="float:right; margin-bottom:12px"><i class="fas fa-plus-circle"> Add Product </i></a> <br>  <br>
