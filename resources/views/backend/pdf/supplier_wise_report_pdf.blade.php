...
<div class="table-responsive">
    ...
    <h3 class="text-center"><strong>Supplier Name : </strong><span class="badge bg-success" style="font-size: 16px;"> {{ $allData['0']['supplier']['name'] }} </span></h3>
    ...
    <table class="table table-striped table-hover">
        ...
        @endforeach
                    ...
                    @else
                    <h4 class="text-center text-danger">No data found for the selected supplier.</h4>
                @endif
