...
@section('content')
    ...
    <div class="card">
        ...
        <div class="message-tabs" style="margin-top: 1rem; display: flex; gap: 0.5rem;">
            <button class="btn btn-tab active" id="inboxTab" onclick="showMessagesTab('inbox')"><i
                    class="fas fa-inbox"></i> Inbox</button>
            <button class="btn btn-tab" id="sentTab" onclick="showMessagesTab('sent')"><i class="fas fa-paper-plane"></i>
                Sent</button>
        </div>
