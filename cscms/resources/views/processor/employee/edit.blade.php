...
@section('content')
    ...
    <div class="content-section fade-in">
        <form action="{{ route('processor.employee.update', $employee->employee_id) }}" method="POST"
            ...
            <div class="form-group">
                ...
                <input type="text" id="employee_name" name="employee_name" class="form-control"
                    value="{{ $employee->employee_name }}" required placeholder="Enter employee's full name">
            </div>
            ...
            <div class="form-group">
                ...
                <select id="skill_set" name="skill_set" class="form-control" required>
                    ...
                    <option value="quality_control" {{ $employee->skill_set == 'quality_control' ? 'selected' : '' }}>
                        Quality Control</option>
                    <option value="maintenance" {{ $employee->skill_set == 'maintenance' ? 'selected' : '' }}>Maintenance
                    </option>
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <select id="primary_station" name="primary_station" class="form-control" required>
                    ...
                    <option value="grading" {{ $employee->primary_station == 'grading' ? 'selected' : '' }}>Grading
                    </option>
                    <option value="roasting" {{ $employee->primary_station == 'roasting' ? 'selected' : '' }}>Roasting
                    </option>
                    <option value="packaging" {{ $employee->primary_station == 'packaging' ? 'selected' : '' }}>Packaging
                    </option>
                    <option value="logistics" {{ $employee->primary_station == 'logistics' ? 'selected' : '' }}>Logistics
                    </option>
                    <option value="quality_control"
                        {{ $employee->primary_station == 'quality_control' ? 'selected' : '' }}>Quality Control</option>
                    <option value="maintenance" {{ $employee->primary_station == 'maintenance' ? 'selected' : '' }}>
                        Maintenance</option>
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <select id="shift_schedule" name="shift_schedule" class="form-control" required>
                    ...
                    <option value="afternoon" {{ $employee->shift_schedule == 'afternoon' ? 'selected' : '' }}>Afternoon
                    </option>
                    <option value="night" {{ $employee->shift_schedule == 'night' ? 'selected' : '' }}>Night</option>
                    <option value="flexible" {{ $employee->shift_schedule == 'flexible' ? 'selected' : '' }}>Flexible
                    </option>
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="number" id="hourly_rate" name="hourly_rate" class="form-control" step="0.01"
                    value="{{ $employee->hourly_rate }}" required placeholder="Enter hourly rate">
            </div>

            <div class="form-group">
                <label for="hire_date">Hire Date</label>
                <input type="date" id="hire_date" name="hire_date" class="form-control"
                    value="{{ $employee->hire_date ? $employee->hire_date->format('Y-m-d') : '' }}" required>
            </div>
            ...
            <div class="form-group">
                ...
                <select id="availability_status" name="availability_status" class="form-control" required>
                    <option value="available" {{ $employee->availability_status == 'available' ? 'selected' : '' }}>
                        Available</option>
                    <option value="busy" {{ $employee->availability_status == 'busy' ? 'selected' : '' }}>Busy</option>
                    <option value="on_break" {{ $employee->availability_status == 'on_break' ? 'selected' : '' }}>On Break
                    </option>
                    <option value="off_duty" {{ $employee->availability_status == 'off_duty' ? 'selected' : '' }}>Off Duty
                    </option>
                    <option value="on_leave" {{ $employee->availability_status == 'on_leave' ? 'selected' : '' }}>On Leave
                    </option>
                </select>
            </div>
