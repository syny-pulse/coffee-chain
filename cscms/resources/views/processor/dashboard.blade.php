    ...
    <div class="metrics-section fade-in">
        ...
        <div class="metrics-grid">
            <div class="metric-card">
                ...
                <div class="metric-progress">
                    <div class="progress-bar"
                        style="width: {{ min(($total_farmer_orders / max($total_farmer_orders, 1)) * 100, 100) }}%"></div>
                </div>
            </div>
            ...
            <div class="metric-card">
                ...
                <div class="metric-progress">
                    <div class="progress-bar"
                        style="width: {{ min(($total_inventory_items / max($total_inventory_items, 1)) * 100, 100) }}%">
                    </div>
                </div>
            </div>
            ...
            <div class="metric-card">
                ...
                <div class="metric-progress">
                    <div class="progress-bar"
                        style="width: {{ min(($total_retailer_orders / max($total_retailer_orders, 1)) * 100, 100) }}%">
                    </div>
                </div>
            </div>
            ...
            <div class="metric-card">
                ...
                <div class="metric-progress">
                    <div class="progress-bar"
                        style="width: {{ min(($total_revenue / max($total_revenue, 1)) * 100, 100) }}%"></div>
                </div>
            </div>
        </div>
    </div>
                ...
                @forelse($farmer_orders->take(3) as $order)
                    <div class="activity-item">
                        ...
                        <div class="activity-content">
                            ...
                            <div class="activity-desc">{{ $order->quantity_kg }}kg {{ $order->coffee_variety }} -
                ...
                @forelse($retailer_orders->take(2) as $order)
                    <div class="activity-item">
                        ...
                        <div class="activity-content">
                            ...
                            <div class="activity-desc">UGX {{ number_format($order->total_amount) }} -
                                {{ $order->order_status }}</div>
                            <div class="activity-time">{{ $order->created_at->diffForHumans() }}</div>
                        </div>
                    </div>
            ...
            <div class="performance-card">
                ...
                <div class="performance-chart">
                    <svg width="120" height="120" viewBox="0 0 120 120">
                        <circle cx="60" cy="60" r="50" fill="none" stroke="rgba(111, 78, 55, 0.1)"
                            stroke-width="8" />
                        <circle cx="60" cy="60" r="50" fill="none" stroke="var(--coffee-medium)"
                            stroke-width="8" stroke-dasharray="314"
                            stroke-dashoffset="{{ 314 - (314 * $processing_efficiency) / 100 }}" stroke-linecap="round"
            ...
            <div class="performance-card">
                ...
                <div class="performance-chart">
                    <svg width="120" height="120" viewBox="0 0 120 120">
                        <circle cx="60" cy="60" r="50" fill="none" stroke="rgba(111, 78, 55, 0.1)"
                            stroke-width="8" />
                        <circle cx="60" cy="60" r="50" fill="none" stroke="var(--coffee-light)"
                            stroke-width="8" stroke-dasharray="314"
                            stroke-dashoffset="{{ 314 - (314 * $order_fulfillment_rate) / 100 }}" stroke-linecap="round"
                            style="transform: rotate(-90deg); transform-origin: 60px 60px;" />
                    </svg>
                    <div class="chart-center">
                ...
                <div class="performance-chart">
                    <svg width="120" height="120" viewBox="0 0 120 120">
                        ...
                        <circle cx="60" cy="60" r="50" fill="none" stroke="var(--success)"
                            stroke-width="8" stroke-dasharray="314"
                            stroke-dashoffset="{{ 314 - (314 * $quality_score_percentage) / 100 }}"
                            stroke-linecap="round" style="transform: rotate(-90deg); transform-origin: 60px 60px;" />
                    </svg>
                    <div class="chart-center">
                ...
                <div class="performance-chart">
                    <svg width="120" height="120" viewBox="0 0 120 120">
                        ...
                        <circle cx="60" cy="60" r="50" fill="none" stroke="var(--accent)"
                            stroke-width="8" stroke-dasharray="314"
                            stroke-dashoffset="{{ 314 - (314 * $customer_satisfaction) / 100 }}" stroke-linecap="round"
                            style="transform: rotate(-90deg); transform-origin: 60px 60px;" />
                    </svg>
                    <div class="chart-center">
...
@push('scripts')
    ...
    <script>
        ...
        const inProcessing =
            {{ $raw_materials ? $raw_materials->sum('quantity_kg') : 0 }}; // Estimate based on raw materials
